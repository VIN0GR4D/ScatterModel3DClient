...
AboutDialog::AboutDialog(QWidget *parent) : QDialog(parent) {
    ...
    QLabel *descriptionLabel = new QLabel("<p>Это приложение предназначено для анализа рассеяния 3D объектов.</p>", this);
    ...
    QLabel *guideLabel = new QLabel(
        ...
        "<li>Загрузите объект с помощью \"Файл\" → \"Открыть\" в меню-баре.</li>"
        "<li>Укажите необходимый(-ые) тип портрета, параметры и угол поворота объекта.</li>"
        "<li>Запустите процесс расчёта с помощью \"Выполнить\" → \"Выполнить расчёт\" в меню-баре.</li>"
        "<li>Авторизируйтесь во всплывающем окне.</li>"
        "<li>Во вкладке \"Результаты\" выберите необходимые расчёты.</li>"
        "</ol>", this);
